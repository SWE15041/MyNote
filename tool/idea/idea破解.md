...
3. 下载补丁jar包，放在idea安装路径的bin目录下
4. 打开idea安装路径的bin目录下修改配置文件idea. vmoptions文件内容：新增参数选项

`-javaagent:D:\tools\IntelliJ IDEA 2019.2.4\bin\jetbrains-agent.jar`

4、重启idea，启用激活码注册

 [jetbrains-agent.jar](../../../../../../Applications/Java/haomiao/jetbrains-agent.jar) 
